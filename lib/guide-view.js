          ...
          <section className='welcome-panel'>
            ...
            <details className='welcome-card' {...this.getSectionProps('project')}>
              ...
              <div className='welcome-detail'>
                ...
                <p>
                  In Nani?! you can open individual files or a whole folder as a
            ...
            <details className='welcome-card' {...this.getSectionProps('packages')}>
              ...
              <div className='welcome-detail'>
                ...
                <p>
                  One of the best things about Nani?! is the package ecosystem.
            ...
            <details className='welcome-card' {...this.getSectionProps('themes')}>
              ...
              <div className='welcome-detail'>
                ...
                <p>
                  Nani?! comes with preinstalled themes. Let's try a few.
                </p>
                <p>
                ...
                <p>
                  You can also install themes created by the Nani?! community. To
            ...
            <details className='welcome-card' {...this.getSectionProps('snippets')}>
              ...
              <div className='welcome-detail'>
                ...
                <p>
                  Nani?! snippets allow you to enter a simple prefix in the editor
            ...
            <details className='welcome-card' {...this.getSectionProps('shortcuts')}>
              ...
              <div className='welcome-detail'>
                ...
                <p>
                  ...
                  Nani?! command. It's a good way to learn more shortcuts. Yes,
                  you can try it now!
                </p>
                <p>
